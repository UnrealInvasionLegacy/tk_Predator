class M_PredatorArmedKiller extends tk_Monster
    config(tk_Monsters);
...
defaultproperties
{
     ...
     DeCloakMat0=Texture'tk_Predator.Predator.Legs3_0'
     DeCloakMat1=Texture'tk_Predator.Predator.Torso3_0'
     DeCloakMat2=Texture'tk_Predator.Predator.head'
     DeCloakMat3=Texture'tk_Predator.Predator.Mask2'
     DeCloakMat4=Texture'tk_Predator.Predator.DroneHead2'
     CloakingMats(0)="tk_Predator.Predator.Legs3_0"
     CloakingMats(1)="tk_Predator.Predator.Torso3_0"
     CloakingMats(2)="tk_Predator.Predator.head"
     CloakingMats(3)="tk_Predator.Predator.Mask2"
     CloakingMats(4)="tk_Predator.Predator.DroneHead2"
     ...
     Mesh=SkeletalMesh'tk_Predator.Predator.HPDroneHunterKiller'
     DrawScale=1.400000
     Skins(0)=Texture'tk_Predator.Predator.Legs3_0'
     Skins(1)=Texture'tk_Predator.Predator.Torso3_0'
     Skins(2)=Texture'tk_Predator.Predator.head'
     Skins(3)=Texture'tk_Predator.Predator.Mask2'
     Skins(4)=Texture'tk_Predator.Predator.DroneHead2'
